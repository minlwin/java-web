		...
		<div class="row">
			<div class="col-4">
				...
				<form action="${signUpUrl}" method="post">
					...
					<div class="mb-3">			
						<label for="loginId">Member Name</label>
						<input name="name" type="text" placeholder="Enter Member Name" class="form-control mt-1" />
					</div>
					...
					<div>
						...
						<a href="${singInUrl}" class="btn btn-secondary">Sign In</a>
					</div>
